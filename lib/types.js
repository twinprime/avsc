...
function UnwrappedUnionType(schema, opts) {
  ...
  if (opts != null && opts.classMapping != null) {
    this._classMapping = opts.classMapping;
  }
  ...
  this.types.forEach(function (type, index) {
    if (Type.isType(type, 'abstract', 'logical')) {
      ...
      if (this._classMapping == null || this._classMapping.getIndex(this, type.name) == null) {
        var bucket = getTypeBucket(type);
...
UnwrappedUnionType.prototype._getIndex = function (val) {
  if (this._classMapping != null && val != null) {
    const index = this._classMapping.getIndex(this, val.constructor.name);
    if (index != null) {
      return index;
    }
  }
...
RecordType.prototype._createConstructor = function (errorStackTraces) {
  if (this._classMapping != null) {
    const constr = this._classMapping.getConstructor(this._getConstructorName());
    if (constr !== undefined) return constr;
  }
